...
(function () {
        ...
        ko.dependentObservable(
            function () {
                ...
                if (bindingContextMayDifferFromDomParentElement)
                    ko.dbindingContextForNode(node, bindingContextInstance);
    ...
    var dbindingContextDomDataKey = "__ko_bindingContext__";
    ko.dbindingContextForNode = function (node, bindingContext) {
        if (arguments.length == 2)
            ko.utils.domData.set(node, dbindingContextDomDataKey, bindingContext);
        else
            return ko.utils.domData.get(node, dbindingContextDomDataKey);
    }
    ...
    ko.contextFor = function(node) {
        ...
        switch (node.nodeType) {
            case 1:
            case 8:
                var context = ko.dbindingContextForNode(node);
